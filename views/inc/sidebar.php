...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <li class="nav-item mt-2">
    <a href="<?php echo APP_URL; ?>?action=logout" class="nav-link text-right" title="Cerrar sesión">
      <i class="nav-icon fas fa-power-off text-danger"></i>
    </a>
  </li>

  <style>
    .nav-item a.nav-link.text-center {
      transition: 0.3s;
    }

    .nav-item a.nav-link.text-center:hover {
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    treeviews.forEach(t => $(t).Treeview('init'));
  });
</script>